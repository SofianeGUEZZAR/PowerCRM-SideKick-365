    ...
    constructor() {
        ...
        this.description = (
            <>
                ...
                <Typography>
                    It displays all the fields and values of the currently open
                    records.
                </Typography>
                <Typography>
                    Expand the box to reveal additional values from the{" "}
                    <i>WebApi</i>, such as the <i>FormattedValue</i>.
                </Typography>
            </>
        );
    }
...
const AllFieldsButtonProcess = forwardRef<ProcessRef, ProcessProps>(
    function AllFieldsButtonProcess(props: ProcessProps, ref) {
        ...
        const attributesRawFiltered = useMemo(() => {
            ...
            return Object.entries(attributes).reduce<{ [key: string]: any }>(
                (acc, [key, value]) => {
                    if (
                        (!notNullOnly ||
...
function AttributeListFilter(
    props: Pick<
        AttributeListCommonProps,
        "filter" | "setFilter" | "notNullOnly" | "setNotNullOnly"
    >
) {
    ...
    return (
        <Stack direction="row" spacing={0.5} width="100%" alignItems="center">
            ...
            <Tooltip
                title={<Typography>Show only fields with values</Typography>}>
                <Checkbox
                    checked={notNullOnly}
...
const AttributeListRaw = React.memo(
    (props: AttributeListRawProps & AttributeListCommonProps) => {
        const {
            attributesRawFiltered,
            copyRawInClipboard,
            forceRefresh,
            ...
            <ThemeProvider theme={theme}>
                <Stack
                    ...
                    <ButtonGroup variant="contained" fullWidth size="small">
                        <Button onClick={copyRawInClipboard}>
                            {copying ? "Copied!" : "Copy"}
                        </Button>
...
const AttributeList = React.memo(
    (props: AttributeListProps & AttributeListCommonProps) => {
        const {
            processId,
            attributesSetFiltered,
            forceRefresh,
                ...
                <Stack
                    ...
                    <DontShowInfo storageName={`${processId}-maininfo`}>
                        <Typography variant="body2">
                            A context menu is available when right-clicking on
                            any item in the list, offering copy options.
                        </Typography>
                    </DontShowInfo>
        ...
        <ListItem
            ...
            <ListItemButton
                ...
                <ListItemText
                    ...
                    secondary={!open ? valueDisplay : null}
                />
...
const AttributeListItemValue = React.memo(
    (props: AttributeListItemValueProps) => {
        const {
            title,
