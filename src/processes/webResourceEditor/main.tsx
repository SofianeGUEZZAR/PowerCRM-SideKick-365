...
class WebResourceEditor extends ProcessButton {
    constructor() {
        ...
        this.description = <>
            ...
            <Typography>This tool adds an <b>editor directly to your browser</b>, allowing you to modify web resources with ease. No more tedious updates and publishing.</Typography>
