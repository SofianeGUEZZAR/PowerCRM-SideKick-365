...
import { editor, KeyCode, KeyMod, type IDisposable } from "monaco-editor";
import React, { useCallback, useEffect, useRef, useState } from "react";

import { type CodeEditorWindowProps } from "../utils/types";

const setRef = (
    ref: React.ForwardedRef<editor.IStandaloneCodeEditor>,
...
const CodeEditorWindow = React.forwardRef<
    editor.IStandaloneCodeEditor,
    CodeEditorWindowProps
>(function CodeEditorWindow(
    props: CodeEditorWindowProps,
    ref: React.ForwardedRef<editor.IStandaloneCodeEditor>
) {
    const {
        file,
    ...
    useEffect(() => {
        ...
        function handleEditorMountGeneric(
            editor: editor.IStandaloneCodeEditor
        ) {
            setRef(ref, editor);
            editor.focus();
            ...
            onChangeRef.current = editor.onDidChangeModelContent(
                handleEditorChangeWithDelay
            );
        ...
        if (editorRef.current) handleEditorMountGeneric(editorRef.current);
